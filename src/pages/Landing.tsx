  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <nav className="container flex items-center justify-between py-6 relative z-10">
        ...
        {user ? (
          <Link to="/servers"><Button variant="default">Open Dashboard</Button></Link>
        ) : (
          <Button onClick={handleLogin} className="bg-[#5865F2] hover:bg-[#5865F2]/90 text-white"><DiscordIcon className="size-4 mr-2" />Login with Discord</Button>
        )}
      </nav>
